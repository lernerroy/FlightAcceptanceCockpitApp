sap.ui.define([
	...
	return BaseController.extend("com.legstate.fts.app.FlightAcceptanceCockpit.controller.lob", {
		...
		_addAirportChargesContent: function(sObjectPath){
			...
			var oPassangerFragment = sap.ui.xmlfragment("com.legstate.fts.app.FlightAcceptanceCockpit.fragments.PassangerDetails", oPassangerFragmentController);
