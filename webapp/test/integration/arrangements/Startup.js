sap.ui.define([
	"sap/ui/test/Opa5",
	"com/legstate/fts/app/FlightAcceptanceCockpit/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.legstate.fts.app.FlightAcceptanceCockpit.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.legstate.fts.app.FlightAcceptanceCockpit",
					async: true
				},
				hash: oOptions.hash,
